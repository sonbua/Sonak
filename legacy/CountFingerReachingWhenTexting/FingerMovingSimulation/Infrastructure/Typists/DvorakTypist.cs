...
namespace FingerMovingSimulation.Infrastructure.Typists
{
    public class DvorakTypist : ITypist
    {
        ...
        public DvorakTypist() : this(new DvorakDefaultMapper())
        {
        }

        public DvorakTypist(IToneMapper toneMapper)
        {
            ...
            characterToLayoutMapper = new CharacterToDvorakLayoutMapper();
        }
