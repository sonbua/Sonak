...
using FingerMovingSimulation.Infrastructure.Hands.Dvorak.Fingers.Left.IndexFinger;
using FingerMovingSimulation.Infrastructure.Hands.Dvorak.Fingers.Left.LittleFinger;
using FingerMovingSimulation.Infrastructure.Hands.Dvorak.Fingers.Left.MiddleFinger;
using FingerMovingSimulation.Infrastructure.Hands.Dvorak.Fingers.Left.RingFinger;
using FingerMovingSimulation.Infrastructure.Hands.Dvorak.Fingers.Left.Thumb;
...
namespace FingerMovingSimulation.Infrastructure.Hands.Dvorak
{
    internal class LeftHand : IHand
    {
        ...
        public double Press(Keys key)
        {
            ...
            throw new NotSupportedException(string.Format("The left hand can't reach this '{0}' button.", key));
        }
    }
}