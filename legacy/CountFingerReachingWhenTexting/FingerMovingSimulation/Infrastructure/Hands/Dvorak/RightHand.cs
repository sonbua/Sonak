...
using FingerMovingSimulation.Infrastructure.Hands.Dvorak.Fingers.Right.IndexFinger;
using FingerMovingSimulation.Infrastructure.Hands.Dvorak.Fingers.Right.LittleFinger;
using FingerMovingSimulation.Infrastructure.Hands.Dvorak.Fingers.Right.MiddleFinger;
using FingerMovingSimulation.Infrastructure.Hands.Dvorak.Fingers.Right.RingFinger;
using FingerMovingSimulation.Infrastructure.Hands.Dvorak.Fingers.Right.Thumb;
using FingerMovingSimulation.Infrastructure.Layouts;
using MiscUtil;

namespace FingerMovingSimulation.Infrastructure.Hands.Dvorak
{
    internal class RightHand : IHand
    {
        ...
        public double Press(Keys key)
        {
            ...
            throw new NotSupportedException(string.Format("The right hand can't reach this '{0}' button.", key));
        }
    }
}